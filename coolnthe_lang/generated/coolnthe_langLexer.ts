...
export class coolnthe_langLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(coolnthe_langLexer._LITERAL_NAMES, coolnthe_langLexer._SYMBOLIC_NAMES, []);

	// @Override
	// @NotNull
	public get vocabulary(): Vocabulary {
		return coolnthe_langLexer.VOCABULARY;
	}
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(coolnthe_langLexer._ATN, this);
	}
	...
	// @Override
	public get ruleNames(): string[] { return coolnthe_langLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return coolnthe_langLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return coolnthe_langLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return coolnthe_langLexer.modeNames; }
	...
	public static get _ATN(): ATN {
		if (!coolnthe_langLexer.__ATN) {
			coolnthe_langLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(coolnthe_langLexer._serializedATN));
		}

		return coolnthe_langLexer.__ATN;
	}
